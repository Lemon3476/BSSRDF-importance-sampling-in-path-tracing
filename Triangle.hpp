        ...
        for (int i = 0; i < mesh.Vertices.size(); i += 3) {
            ...
            for (int j = 0; j < 3; j++) {
                auto vert = Vector3f(mesh.Vertices[i + j].Position.X,
                                     ...
                                     mesh.Vertices[i + j].Position.Z)*60.0f;
...
inline Intersection Triangle::getIntersection(Ray ray)
{
    ...
    {
// std::cout<<"intersection error 1"<<std::endl;
    return inter;
    }
	...
	if (fabs(det) < EPSILON)
    {
// std::cout<<"intersection error 2"<<std::endl;
    return inter;
    }
	...
	if (u < 0 || u > 1)
    {
// std::cout<<"intersection error 3"<<std::endl;
    return inter;
    }
	...
	if (v < 0 || u + v > 1)
    {
// std::cout<<"intersection error 4"<<std::endl;
    return inter;
    }
	...
	if (t_tmp <= 0)
    {
// std::cout<<"intersection error 5"<<std::endl;
    return inter;
    }
	...
	inter.obj = this;
    inter.mesh = this->getMesh();
    inter.ray = &ray;
// std::cout<<"material in Triangle intersection: "<<inter.m->m_type<<std::endl;
	return inter;
}
